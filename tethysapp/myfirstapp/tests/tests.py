    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.myfirstapp"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.myfirstapp.tests.tests"

        To run tests in the MyfirstappTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.myfirstapp.tests.tests.MyfirstappTestCase"

        To run only the test_if_tethys_platform_is_great function in the MyfirstappTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.myfirstapp.tests.tests.MyfirstappTestCase.test_if_tethys_platform_is_great"
...
class MyfirstappTestCase(TethysTestCase):
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/myfirstapp/')  # The final '/' is essential for all pages/controllers
